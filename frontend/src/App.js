...
function AppWithNavBar() {
  ...
  const showNavbarOn = ["/", "/view-profile","/mentorship-home" ,"/login", "/choosesignup","/contact-us","/forgot-password", "/reset-password", "/update-profile", "/events", "/search-alumni", "/gallery","/developers-info"];
